 ...
 * |-------+-------+-------+-------+-------+--------+--------+-------+-------+-------+-------+-------|
 * | Brite |  GUI  |  Alt  | LEFT  | Lower | SP/Sft | SP/Sft | Raise |   ↑   |   ←   |   ↓   |   →   |
 * `-------------------------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_preonic_grid( \
  KC_GESC,  KC_1,    KC_2,    KC_3,   KC_4,    KC_5,      KC_6,    KC_7,    KC_8,    KC_9,    KC_0,     KC_DEL,    \
  KC_TAB,   KC_Q,    KC_W,    KC_E,   KC_R,    KC_T,      KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,     KC_BSPC,   \
  KC_LCTL,  KC_A,    KC_S,    KC_D,   KC_F,    KC_G,      KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN,  QUOT_LCTL, \
  KC_LSFT,  KC_Z,    KC_X,    KC_C,   KC_V,    KC_B,      KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_ENT,    \
  BACKLIT,  KC_LGUI, KC_LALT, MO_DIG, LOWER,   SP_RSFT,   SP_RSFT, RAISE,   KC_UP  , KC_LEFT, KC_DOWN,  KC_RGHT    \
),
...
[_LOWER] = LAYOUT_preonic_grid( \
  TG(_FN),   KC_0,      KC_9,    KC_8,    KC_7,     KC_6,     _______, _______, _______, _______, _______, _______, \
  KC_BSPC,   KC_P,      O_CWIN,  KC_I,    KC_U,     KC_Y,     KC_WH_U, KC_BTN2, KC_MS_U, KC_WH_L, KC_WH_R, _______, \
  QUOT_LCTL, KC_SCLN,   KC_L,    KC_K,    KC_J,     KC_H,     KC_WH_D, KC_MS_L, KC_MS_D, KC_MS_R, _______, _______, \
